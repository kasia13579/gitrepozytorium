...
(
    ...
    oceny INTEGER
    FOREIGN KEY (id_uczen) REFERENCES klasy(id) ON DELETE NO ACTION ON UPDATE NO ACTION
    FOREIGN KEY (id_przedmiot) REFERENCES klasy(id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
